...
#------------------------------------------------------------------ SST accummulation to seasons and separation
{
  ...
  # AMM.seasons[2:length(Years),"DJF"] <- AMM.s[which(substr(Year.s,6,8) == "DJF") [-1]]
...
#### identification of periods SST higher and lower than 0.5 --------
...
for ( i in seasons){
  W.E.anom[["Pos"]][,i] <- apply( W.E.seasons[[i]][AMM.bool[["Pos"]][,i],]  ,2,mean,na.rm=T) - Mean.MtE.seasons[,i]
  W.N.anom[["Pos"]][,i] <- apply( W.N.seasons[[i]][AMM.bool[["Pos"]][,i],]  ,2,mean,na.rm=T) - Mean.MtN.seasons[,i]
  ...
  W.E.anom[["Neg"]][,i] <- apply( W.E.seasons[[i]][AMM.bool[["Neg"]][,i],]  ,2,mean) - Mean.MtE.seasons[,i]
  W.N.anom[["Neg"]][,i] <- apply( W.N.seasons[[i]][AMM.bool[["Neg"]][,i],]  ,2,mean) - Mean.MtN.seasons[,i]
...
{
#   plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "DJF", title.p = "Anomaly Composite Winds - DJF (1980-2020, AMM >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "MAM", title.p = "Anomaly Composite Winds - MAM (1980-2020, AMM >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "JJA", title.p = "Anomaly Composite Winds - JJA (1980-2020, AMM >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "SON", title.p = "Anomaly Composite Winds - SON (1980-2020, AMM >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "DJF", title.p = "Anomaly Composite Winds - DJF (1980-2020, AMM <= -0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "MAM", title.p = "Anomaly Composite Winds - MAM (1980-2020, AMM <= -0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "JJA", title.p = "Anomaly Composite Winds - JJA (1980-2020, AMM <= -0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "SON", title.p = "Anomaly Composite Winds - SON (1980-2020, AMM <= -0.5)")
}
...
{plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "DJF", title.p = "Anomaly Composite Winds - DJF (1980-2020, AMM >= 1*SD)")

plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "MAM", title.p = "Anomaly Composite Winds - MAM (1980-2020, AMM >= 1*SD)")

plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "JJA", title.p = "Anomaly Composite Winds - JJA (1980-2020, AMM >= 1*SD)")

plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "SON", title.p = "Anomaly Composite Winds - SON (1980-2020, AMM >= 1*SD)")

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "DJF", title.p = "Anomaly Composite Winds - DJF (1980-2020, AMM <= -1*SD)")

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "MAM", title.p = "Anomaly Composite Winds - MAM (1980-2020, AMM <= -1*SD)")

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "JJA", title.p = "Anomaly Composite Winds - JJA (1980-2020, AMM <= -1*SD)")

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "SON", title.p = "Anomaly Composite Winds - SON (1980-2020, AMM <= -1*SD)")}
