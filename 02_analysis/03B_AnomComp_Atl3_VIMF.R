...
#------------------------------------------------------------------ VIMF accummulation to seasons and separation
{
...
for ( i in seasons){
  ...
  E.Pos <- Mt.E.seasons[[i]][Atl3.bool[["Pos"]][,i],]; N.Pos <- Mt.N.seasons[[i]][Atl3.bool[["Pos"]][,i],]
  ...
  E.Neg <- Mt.E.seasons[[i]][Atl3.bool[["Neg"]][,i],]; N.Neg <- Mt.N.seasons[[i]][Atl3.bool[["Neg"]][,i],]
  ...
  neutral <- !(Atl3.bool[["Pos"]][,i] | Atl3.bool[["Neg"]][,i])
  E.neutral <- Mt.E.seasons[[i]][neutral,]; N.neutral <- Mt.N.seasons[[i]][neutral,]
...
# ---------------------------------------------------------------------------------------------------------- filtering arrows for better visualization
{
  ...
  sele[["lon"]] <- seq(-83,-30,by=0.5)
  sele[["lat"]] <- seq(-21,16,by=0.5)
...
{
#   plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "DJF", title.p = "Anomaly Composite VIMF - DJF (1980-2020, Atl3 >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "MAM", title.p = "Anomaly Composite VIMF - MAM (1980-2020, Atl3 >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "JJA", title.p = "Anomaly Composite VIMF - JJA (1980-2020, Atl3 >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Pos"]], Spe.season = "SON", title.p = "Anomaly Composite VIMF - SON (1980-2020, Atl3 >= 0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "DJF", title.p = "Anomaly Composite VIMF - DJF (1980-2020, Atl3 <= -0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "MAM", title.p = "Anomaly Composite VIMF - MAM (1980-2020, Atl3 <= -0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "JJA", title.p = "Anomaly Composite VIMF - JJA (1980-2020, Atl3 <= -0.5)")
# 
# plotting.anom(data.mean, data.anom = data.anom[["Neg"]], Spe.season = "SON", title.p = "Anomaly Composite VIMF - SON (1980-2020, Atl3 <= -0.5)")
}
...
{plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "DJF", title.p = "Anomaly Composite VIMF - DJF (1980-2020, Atl3 >= 1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "MAM", title.p = "Anomaly Composite VIMF - MAM (1980-2020, Atl3 >= 1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "JJA", title.p = "Anomaly Composite VIMF - JJA (1980-2020, Atl3 >= 1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Pos"]], Spe.season = "SON", title.p = "Anomaly Composite VIMF - SON (1980-2020, Atl3 >= 1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "DJF", title.p = "Anomaly Composite VIMF - DJF (1980-2020, Atl3 <= -1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "MAM", title.p = "Anomaly Composite VIMF - MAM (1980-2020, Atl3 <= -1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "JJA", title.p = "Anomaly Composite VIMF - JJA (1980-2020, Atl3 <= -1*SD)",xlim=c(-82,-31))

plotting.anom2(data.anom = data.anom[["Neg"]], Spe.season = "SON", title.p = "Anomaly Composite VIMF - SON (1980-2020, Atl3 <= -1*SD)",xlim=c(-82,-31))}
